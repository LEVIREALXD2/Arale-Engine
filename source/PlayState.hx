...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Tai', 0.4], //From 20% to 39%
		['Burul', 0.5], //From 40% to 49%
		['bjir', 0.6], //From 50% to 59%
		['Lah', 0.69], //From 60% to 68%
		['Lumayan', 0.7], //69%
		['Bagus', 0.8], //From 70% to 79%
		['Menarik', 0.9], //From 80% to 89%
	...
	public dynamic function updateScoreText()
	{
		...
		if(!instakillOnMiss) tempScore = 'Nilai: ${songScore} | Gameplay by: LG64 | Meleset: ${songMisses} | Rating: ${str}';
