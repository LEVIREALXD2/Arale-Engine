...
class ModPackSwitchMenu extends MusicBeatSubstate {
	...
	public override function update(elapsed:Float) {
		if (controls.ACCEPT) {
			...
			ClientPrefs.data.currentModPack = mods[curSelected];
			ClientPrefs.saveSettings();

			#if SCRIPTING_ALLOWED
			Script.staticVariables = []; //make sure nothings left from previous modpack
			#end
			//Restart the game
