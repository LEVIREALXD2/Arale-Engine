...
class MouseMove extends FlxBasic
{
	...
	private var dragSensitivity:Float = 1.0;
	private var deceleration:Float = 0.9;
	private var minVelocity:Float = 0.001;

	public var mouseWheelSensitivity:Float = 20.0;
	...
	private function velocityChange() {
		...
		for (i in 0...filtered.length) {
			var weight = (i + 1) / filtered.length;
